...
interface PaginationMeta {
  ...
  handleToggleActive: (amenity: Amenity) => void
...
export default function SystemAmenitiesPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Tabs — Hotel vs Room */}
<Tabs defaultValue="hotel" className="flex flex-col gap-4">

  <div className="flex justify-center">
    <TabsList className="inline-flex h-11 rounded-xl bg-secondary/50 p-1">
      <TabsTrigger value="hotel" className="gap-2 px-5">
      ...
      <TabsTrigger value="room" className="gap-2 px-5">
