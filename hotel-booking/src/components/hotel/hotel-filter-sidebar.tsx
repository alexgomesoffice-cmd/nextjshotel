...
const HotelFilterSidebar = () => {
  ...
  return (
    <div className="w-full bg-card border border-border/50 rounded-2xl p-5 shadow-sm top-24 animate-fade-in">
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-2">
                <div className="relative flex-1">
                  <span className="absolute left-3 top-1/2 -translate-y-1/2 text-muted-foreground text-xs">BDT </span>
                  <input 
                    type="number" 
                    placeholder=" Min"
